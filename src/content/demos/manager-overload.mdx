...
**The agreement:** You build the shared priority list this week and walk through the order with Dana. For the next two weeks, any new request goes onto the list, and the two of you decide together what moves before you say yes. **The test:** zero silent additions — nothing lands on your plate without an explicit trade-off decision — and no evenings spent absorbing work that never got discussed. **The review:** at your one-on-one in two weeks, you look at it together — did the list stay current, did the rule hold, does anything need adjusting?
