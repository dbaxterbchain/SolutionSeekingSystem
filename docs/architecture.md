...
| `/course/learn/certificate` | `pages/course/learn/certificate.astro` | The learner's certificate: name confirmation, printing and the verification link (`CertificateView` island) |
