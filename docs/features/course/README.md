...
The purchase, the learner area, and the assessed certification path, captured across the four
sub-plans that built them. Verified end to end in a real browser against the local Supabase
stack: a real Stripe test-mode purchase, real autosaves, and two real grades from
`claude-opus-5`. See [../../roadmap.md](../../roadmap.md) Phase 6 for the plan and
...
| ![Sales page, phone](course-sales-preview-390.png) | **`course-sales-preview-390.png`**: the same page at 390px. Hero, first CTA and syllabus all reachable with no horizontal scroll. |
...
| ![Dashboard, enrolled](course-dashboard-ready-1280.png) | **`course-dashboard-ready-1280.png`**: the same URL after a completed purchase. The enrollment is recognised through `/api/course/entitlement` and the module list, progress and worksheets appear. |
...
| ![Worksheet at phone width](course-worksheet-390.png) | **`course-worksheet-390.png`**: the same worksheet on screen at 390px, readable without zooming. |
...
| ![Assessment part B, phone](assessment-part-b-open-390.png) | **`assessment-part-b-open-390.png`**: the same locked state at 390px, including the read-only earlier answers. |
...
| ![Passed result, phone](assessment-result-passed-390.png) | **`assessment-result-passed-390.png`**: the same result at 390px, criteria and evidence intact. |
...
| ![Grading error on the dashboard](dashboard-certification-card-grading-error-1280.png) | **`dashboard-certification-card-grading-error-1280.png`**: the same state on the learner dashboard's certification card, so somebody who navigates away still finds out what happened. |
...
| ![Account menu, not enrolled](account-menu-explore-course-1280.png) | **`account-menu-explore-course-1280.png`**: the same menu for an account with no enrollment, offering "Explore the course" into the sales page instead. One entry, never both. |
...
| ![Certification page, phone](certification-page-390.png) | **`certification-page-390.png`**: the same page at 390px, the criteria readable without horizontal scroll. |
